<?php
class User extends AuthAppModel {
    /**
    ...
    var $validate = array(
        ...
        'email' => array(
            ...
            'unique' => array(
                'rule'      => 'isUnique',
                //'message'   => 'Already taken.', // into the controller to be able to use $html->link
            ),
        ),
        'password' => array(
            'empty' => array(
    ...
    var $validateNoPassword = array(
        '_import' => array('email', 'username')
    );
    /**
     * Extra form dependent validation rules
     */
    var $validateChangePassword = array(
        '_import' => array('email', 'username', 'password', 'password_confirm'),
        'password_old' => array(
            'correct' => array(
                'rule'      => 'password_old',
